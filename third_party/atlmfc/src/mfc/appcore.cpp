...
static HINSTANCE AfxLoadLangResourceDLLEx(LPCTSTR pszFormat, LPCTSTR pszPath)
{
...
HINSTANCE AFXAPI AfxLoadLangResourceDLL(LPCTSTR pszFormat)
{
	...
	return AfxLoadLangResourceDLLEx(pszNewFormat, _T(""));
}
...
HINSTANCE CWinApp::LoadAppLangResourceDLL()
{
	...
	*pszExtension = '\0';
	...
	return AfxLoadLangResourceDLLEx(szFormat, szPath);
}
